	...
	var DateTimeField = (function (_Component) {
	  ...
	  function DateTimeField() {
	    ...
	    this.componentWillReceiveProps = function (nextProps) {
	      ...
	      var defaultAttributes = _this.__proto__.constructor.defaultProps;

	      if (_this.props.defaultText !== "undefined" && nextProps.dateTime == defaultAttributes.dateTime) {
	        state.inputValue = _this.props.defaultText;
	      }
